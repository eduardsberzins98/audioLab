% Code for a IIR Comb filter (infinte echo audio effect)
...
delaySeconds = 200E-3; % Desired echo delay in seconds (>100ms)
...
while toc < 20 % How long to run the code
    ...
    for n = 1:frameSize
        ...
        circBuffer(newest+1)=frameIn(n) + gain*circBuffer(oldest+1); % Load in newst sample + effect
